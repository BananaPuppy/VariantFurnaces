...
public class CrystalFurnace extends AbstractVFurnaceBlock {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return CrystalFurnace.checkType(type, ModBlockEntities.CRYSTAL_FURNACE, CrystalFurnaceBlockEntity::tick);
    }
