...
public class GoldFurnace extends AbstractVFurnaceBlock {
    public GoldFurnace(FabricBlockSettings settings) {
        super(settings, MapColor.GOLD, Blocks.GOLD_BLOCK.getDefaultState().getInstrument(), 5.0f, 6.0f, 13, Blocks.GOLD_BLOCK.getDefaultState().getSoundGroup(), GoldDiamondUpgrade.class);
    }
