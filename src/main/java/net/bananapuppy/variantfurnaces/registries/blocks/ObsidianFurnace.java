...
public class ObsidianFurnace extends AbstractVFurnaceBlock {
    public ObsidianFurnace(FabricBlockSettings settings) {
        super(settings, MapColor.BLACK, Blocks.OBSIDIAN.getDefaultState().getInstrument(), 50.0f, 1200.0f, 13, Blocks.OBSIDIAN.getSoundGroup(Blocks.OBSIDIAN.getDefaultState()));
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return ObsidianFurnace.checkType(type, ModBlockEntities.OBSIDIAN_FURNACE, ObsidianFurnaceBlockEntity::tick);
    }
