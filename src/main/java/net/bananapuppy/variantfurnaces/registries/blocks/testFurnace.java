...
public class testFurnace extends BaseVFurnaceBlock {

    public testFurnace(FabricBlockSettings settings) {
        super(settings, MapColor.IRON_GRAY, Instrument.IRON_XYLOPHONE, 5.0f, 6.0f, 13);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return testFurnace.checkType(type, ModBlockEntities.TEST_FURNACE, testFurnaceBlockEntity::tick);
    }
